...
try
{
        ...
        pelvis_tx.setName("mov_pelvis_x");
        ...
        pelvis_ty.setName("mov_pelvis_y");
...
//create contact between low point and ground
	...
	double cstiffness = 1.0e8, cdissipation = 0.5, friction = 0.9, viscosity = 0.6;
